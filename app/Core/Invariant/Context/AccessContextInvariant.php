...
final class AccessContextInvariant
{
    ...
    private function __construct() {
        /*
         * GUIA DE MANUTENÇÃO — Core.Invariant.Context.AccessContextInvariant::__construct
         * Responsabilidade: Inicializa ou restringe a criação da instância responsável por este serviço, estabelecendo as dependências necessárias antes do uso.
         * Local arquitetural: app/Core/Invariant/Context/AccessContextInvariant.php (núcleo de invariantes e decisões canônicas).
    ...
    {
        /*
         * GUIA DE MANUTENÇÃO — Core.Invariant.Context.AccessContextInvariant::supports
    ...
    {
        /*
         * GUIA DE MANUTENÇÃO — Core.Invariant.Context.AccessContextInvariant::assertWrite
