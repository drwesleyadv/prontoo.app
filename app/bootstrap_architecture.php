...
$__prontoo_core_files = [
    ...
    __DIR__ . '/Infrastructure/Audit/AuditChain.php',
    __DIR__ . '/Core/Temporal/PiTime.php',
    __DIR__ . '/Infrastructure/Database/SeqContract.php',
    __DIR__ . '/Infrastructure/Integrity/PiIntegrity.php',
    __DIR__ . '/Runtime/Tenant/SessionTenantContext.php',
    __DIR__ . '/Runtime/Tenant/SessionTenantAccess.php',
