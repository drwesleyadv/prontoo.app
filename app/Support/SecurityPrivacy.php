...
{
    return \Prontoo\Infrastructure\SecurityPrivacy\SecurityPrivacyInfrastructureOperations01::security_ip_in_cidr($ip, $cidr);
}
function security_trusted_proxy_request(): bool
{
    return \Prontoo\Runtime\SecurityPrivacy\SecurityPrivacyRuntimeOperations01::security_trusted_proxy_request();
}
...
{
    return \Prontoo\Infrastructure\SecurityPrivacy\SecurityPrivacyInfrastructureOperations01::privacy_sanitize_text($text, $limit);
}

function privacy_sanitize_error_message(Throwable $e, int $limit = 900): string
{
    return \Prontoo\Infrastructure\SecurityPrivacy\SecurityPrivacyInfrastructureOperations01::privacy_sanitize_error_message($e, $limit);
}

function privacy_log_file_label(string $file): string
{
    return \Prontoo\Infrastructure\SecurityPrivacy\SecurityPrivacyInfrastructureOperations01::privacy_log_file_label($file);
}
