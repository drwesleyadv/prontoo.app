...
- Nas telas autenticadas, duas linhas decorativas no rodapé reutilizam os mesmos 30 pontos de Carregamento de Páginas e Consulta de Volume por uma rota JSON privada; nenhuma telemetria é devolvida pelas rotas públicas.
