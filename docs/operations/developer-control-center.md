...
- Abaixo dos cards, Métricas preserva os gráficos **Velocidade** e **Volume**, atualizados a cada minuto, sem incorporar a tabela de Rotas. Ambos exibem Carregamento de Páginas e Consulta, com zero explícito nos intervalos sem eventos e segmentos retos entre pontos. Velocidade usa os 1.440 minutos completos das últimas 24 horas e uma marca por hora no eixo inferior; Volume usa 30 pontos, um para cada intervalo de 24 horas dos últimos 30 dias.
