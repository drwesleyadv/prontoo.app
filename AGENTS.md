...
As telas autenticadas exibem duas linhas decorativas no rodapé. Elas consomem somente a rota privada `footer_telemetry_wave` e reutilizam os mesmos 30 pontos de Carregamento de Páginas e Consulta do gráfico Volume. A rota pública histórica de telemetria permanece neutralizada e não pode voltar a expor dados operacionais.
