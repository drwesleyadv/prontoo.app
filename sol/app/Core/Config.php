...
final class Config
{
    ...
    public static function boot(string $root): void
    {
        ...
        self::$values = [
            ...
            'binance_book_ticker' => 'https://api.binance.com/api/v3/ticker/bookTicker',
            'binance_ws_stream' => 'wss://stream.binance.com:9443/stream',
            'solana_rpc' => 'https://api.mainnet-beta.solana.com',
            'csrf_token' => getenv('PRO_CSRF_TOKEN') ?: 'troque_por_um_token_seguro_em_producao',
            'max_1m_candles' => 10080,
            ...
            'historical_fetch_chunk_seconds' => 604800,
    ...
    public static function path(string $relative): string { return self::$root . '/' . ltrim($relative, '/'); }
}
