    ...
    "@graph" => [
        ...
        [
            ...
            "mainEntity" => array_map(
                static /* Guia de manutenção: Executa uma transformação curta usada como callback no módulo de site público e landing page. Dependências diretas: nenhuma dependência direta detectada estaticamente. Efeitos: transformação local sem efeito externo detectado. */ fn(array $item): array => [
                    "@type" => "Question",
                    "name" => $item["q"],
                    "acceptedAnswer" => [
                        "@type" => "Answer",
